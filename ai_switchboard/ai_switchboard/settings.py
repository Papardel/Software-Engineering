"""
Django settings for ai_switchboard project.
...
SECRET_KEY = 'django-insecure-6v+g65wz#5!#-f%rh*#$i0qlj$uta1yibrik8i_irqtv)o=n^1'
...
ROOT_URLCONF = 'ai_switchboard.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': ['ai_switchboard/web_app/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'ai_switchboard.wsgi.application'
